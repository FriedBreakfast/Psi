...
namespace Psi {
  namespace Tvm {
    TermPtr<> ArithmeticOperation::integer_binary_op_type(Context&, TermRefArray<> parameters) {
      if (parameters.size() != 2)
        throw std::logic_error("binary arithmetic operation expects two operands");

      TermPtr<> type = parameters[0]->type();
    ...
    TermPtr<> IntegerAdd::type(Context& context, TermRefArray<> parameters) const {
    ...
    TermPtr<> IntegerSubtract::type(Context& context, TermRefArray<> parameters) const {
      return ArithmeticOperation::integer_binary_op_type(context, parameters);
    }
    ...
    TermPtr<> IntegerMultiply::type(Context& context, TermRefArray<> parameters) const {
      return ArithmeticOperation::integer_binary_op_type(context, parameters);
    }
    ...
    TermPtr<> IntegerDivide::type(Context& context, TermRefArray<> parameters) const {
      return ArithmeticOperation::integer_binary_op_type(context, parameters);
    }
