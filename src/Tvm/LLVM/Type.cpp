...
namespace Psi {
  namespace Tvm {
    namespace LLVM {
      struct TypeBuilder {
        static llvm::Type *metatype_callback(ModuleBuilder& builder, Metatype::Ptr) {
        ...
        static llvm::Type* empty_type_callback(ModuleBuilder& builder, EmptyType::Ptr) {
          return llvm::StructType::get(builder.llvm_context());
        }
        
        static llvm::Type* pointer_type_callback(ModuleBuilder& builder, PointerType::Ptr term) {
          return builder.build_type(term->target_type())->getPointerTo();
        }
        
        static llvm::Type* block_type_callback(ModuleBuilder& builder, BlockType::Ptr) {
          return llvm::Type::getLabelTy(builder.llvm_context());
        }
        
        static llvm::Type* byte_type_callback(ModuleBuilder& builder, ByteType::Ptr) {
          return llvm::Type::getInt8Ty(builder.llvm_context());
        }

        static llvm::Type* boolean_type_callback(ModuleBuilder& builder, BooleanType::Ptr) {
          return llvm::Type::getInt1Ty(builder.llvm_context());
        }

        static llvm::Type* integer_type_callback(ModuleBuilder& builder, IntegerType::Ptr term) {
          return integer_type(builder.llvm_context(), builder.llvm_target_machine()->getTargetData(), term->width());
        }

        static llvm::Type* float_type_callback(ModuleBuilder& builder, FloatType::Ptr term) {
          return float_type(builder.llvm_context(), term->width());
        }

        static llvm::Type* array_type_callback(ModuleBuilder& builder, ArrayType::Ptr term) {
        ...
        static llvm::Type* struct_type_callback(ModuleBuilder& builder, StructType::Ptr term) {
        ...
        typedef TermOperationMap<FunctionalTerm, llvm::Type*, ModuleBuilder&> CallbackMap;
       ...
       */
      llvm::Type* ModuleBuilder::build_type_internal(FunctionalTerm *term) {
